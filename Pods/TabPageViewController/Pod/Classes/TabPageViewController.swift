...
public class TabPageViewController: UIPageViewController {
    ...
    override public func viewDidLoad() {
       ...
       NSNotificationCenter.defaultCenter().addObserver(self, selector:"scrollStateChange:", name: "touchState", object: nil)
    }
    ...
    func scrollStateChange(title:NSNotification){
        
        let dict =  title.object?.objectForKey("touchTag")?.intValue
...
extension TabPageViewController {
    ...
    private func setupScrollView() {
        ...
        scrollView = view.subviews.flatMap { $0 as? UIScrollView }.first
